...
Listing.hasMany(ExperienceType, {
  foreignKey: "listId",
  as: "experienceTypes",
  onUpdate: "cascade",
  onDelete: "cascade",
...
Listing.hasMany(ExperienceHours, {
  foreignKey: "listId",
  as: "experienceHours",
  onUpdate: "cascade",
  onDelete: "cascade",
...
Listing.hasMany(PlusesIncluded, {
  foreignKey: "listId",
  as: "plusesIncluded",
  onUpdate: "cascade",
  onDelete: "cascade",
...
Listing.hasMany(SpokenLanguages, {
  foreignKey: "listId",
  as: "spokenLanguages",
  onUpdate: "cascade",
  onDelete: "cascade",
...
ExperienceType.belongsTo(ListSettings, {
...
PlusesIncluded.belongsTo(ListSettings, {
  foreignKey: "plusId",
  as: "listSettings",
  onUpdate: "cascade",
  onDelete: "cascade",
...
SpokenLanguages.belongsTo(ListSettings, {
