...
class ViewListing extends React.Component {
  ...
  render() {
    ...
    console.log("ListBlockedDates: ", ListingBlockedDates);
            ...
            UserListing && <div className={s.pageContainer}>
              ...
              <Element name="test1" className="element">
                <Grid fluid className={cx(s.horizontalLineThrough)}>
                    ...
                    <Col xs={12} sm={12} md={4} lg={4} className={s.positionSticky}>
                      {
                        !smallDevice && !loading && <div className={cx(s.responsiveNopadding, 'hidden-xs hidden-sm')}>
                          ...
                          <Calendar
                            ...
                            personCapacity={UserListing.personCapacity}
                            adultCapacity={UserListing.adultCapacity}
                            teenCapacity={UserListing.teenCapacity}
                            childOrYoungerCapacity={UserListing.childOrYoungerCapacity}
                            listingData={UserListing.listingData || undefined}
                            isHost={isHost}
                  ...
                  {
                    similarListsData && similarListsData.getSimilarListing && similarListsData.getSimilarListing.length > 0 && <Grid fluid className={cx(s.space2, s.noPaddingMobile)}>
                      <Row className={cx(s.pageContent, s.space3, s.sliderMargin, 'similarListing')}>
                  ...
                  <div className={cx(s.displayTable, s.displayTableMobile)}>
                    <div className={cx(s.smSpace, s.displayTableCell, s.displayBlockMobile)}>
                      <div className={(s.bookItPriceAmount)}>
                        ...
                        <span className={s.bookItNight}>{' '}<FormattedMessage {...messages.perPerson} /></span>
                      </div>
                      <div>
