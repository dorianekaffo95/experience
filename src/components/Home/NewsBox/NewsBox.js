              ...
              <Row>
                ...
                <Col lg={6} md={6} sm={6} xs={12}>
                  <div className={cx(s.tableCell, s.textColumn, s.desktopView)}>
                    <h3 className={s.title}><FormattedMessage {...messages.imageBannerTitle}/>{/* title */}</h3>
                    <p className={s.caption}><FormattedMessage {...messages.imageBannerDescription}/>{/* description */}</p>
                    <Link
                      to={"/whyhost"}
                      className={cx(s.btn, s.btnPrimary)}
                    >
                      <FormattedMessage {...messages.imageBannerButtonLabel} />{/* buttonLabel */}
                    </Link>
                  </div>
                </Col>
              </Row>
