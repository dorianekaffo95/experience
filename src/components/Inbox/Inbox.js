...
class Inbox extends React.Component {
  ...
  render() {
    const {
      allThreads: { loading, GetAllThreads },
    } = this.props;
    const {
    ...
    if (getUnreadCount) {
      host =
        getUnreadCount.hostCount != null && getUnreadCount.hostCount > 0
          ? getUnreadCount.hostCount
          : null;
      guest =
        getUnreadCount.guestCount != null && getUnreadCount.guestCount > 0
          ? getUnreadCount.guestCount
          : null;
    }
    return (
      <div
            ...
            <Col xs={12} sm={12} md={12} lg={12}>
              <Panel className={s.panelHeader}>
                        ...
                        if (item.guestProfile && item.hostProfile) {
                          return (
                            <InboxItem
                              ...
                              displayName={
                                type === "host"
                                  ? item.guestProfile.displayName
                                  : item.hostProfile.displayName
                              }
                ...
                {!loading &&
                  GetAllThreads &&
                  GetAllThreads.threadsData &&
                  GetAllThreads.threadsData.length === 0 && <EmptyInbox />}
