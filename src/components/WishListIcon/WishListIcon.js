            ...
            <div>
                {
                    type == 'icon' && <div className={cx(s.iconContainer, heartIcon)} onClick={this.iconAction}>
                        ...
                        {
                            iconSelected && <img src={heartIconFill} className={s.wishListIcon} />
                        }
                        {/* {
                            !iconSelected && <FontAwesome.FaHeartO className={s.wishListIcon} />
                        }   */}
                        {
                            !iconSelected && <img src={heartImage} className={s.wishListIcon} />
                        }
                    </div>
                }
                {
                    type == 'button' && <div className={s.buttonContainer} onClick={this.iconAction}>
                        ...
                        {
                            iconSelected && <img src={heartIconFill} className={cx(s.wishListIcon, s.vtrMiddle)} />
                        }
                        {
                            !iconSelected && <img src={heartImage} className={cx(s.wishListIcon, s.vtrMiddle)} />
                        }
