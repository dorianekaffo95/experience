                ...
                <form onSubmit={handleSubmit(submit)}>
                  ...
                  <Col xs={12} sm={12} md={12} lg={4}>
                    <Row>
                      <FormGroup className={s.formGroup}>
                        <Col xs={12} sm={12} md={12} lg={12} componentClass={ControlLabel}>
                          <label className={s.labelText} >Home Page Logo</label>
                        </Col>
                        <Col xs={12} sm={12} md={12} lg={12} componentClass={ControlLabel} className={s.marbtm14}>
                          <HomeUploader />
                        </Col>
                  ...
                  <Col xs={12} sm={12} md={12} lg={4} componentClass={ControlLabel} className={s.marbtm14}>
                    <Col xs={12} sm={12} md={12} lg={12} componentClass={ControlLabel}>
                      <label className={s.labelText} >Email Logo</label>
                    </Col>
                    <EmailLogoUploader />
                  </Col>
                  <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                    ...
                    <Col xs={12} sm={12} md={12} lg={4} className={s.space2}>
                      <Field name="appStoreLink" type="text" component={this.renderFormControl} label={"App Store Link"} />
                    </Col>
                    <Col xs={12} sm={12} md={12} lg={4} className={s.space2}>
                      <Field name="playStoreLink" type="text" component={this.renderFormControl} label={"Play Store Link"} />
                    </Col>
                  </Col>
