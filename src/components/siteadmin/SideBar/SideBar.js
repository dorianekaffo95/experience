                ...
                <ul className={s.sidebarNav}>
                    ...
                    <li>
                        ...
                        <Collapse in={this.state.home} className={s.subMenu}>
                            <div>
                                ...
                                <Link to={"/siteadmin/home/static-info-block"}>
                                    <FontAwesome.FaCircleThin className={s.navigationIcon} />
                    ...
                    <li>
                        ...
                        <Collapse in={this.state.step1} className={s.subMenu}>
                            <div>
                            <Link to={"/siteadmin/listsettings/22"}>
                                <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                <span>Experience Type</span>
                            </Link>
                            <Link to={"/siteadmin/listsettings/21"}>
                                <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                <span>Pluses Included</span>
                            </Link>
                            ...
                            <Link to={"/siteadmin/listsettings/6"}>
                                <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                <span>Owner Care</span>
                            </Link>
                            <Link to={"/siteadmin/listsettings/7"}>
                                <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                <span>Family Welcome</span>
                            </Link>
                        ...
                        <Collapse in={this.state.step3} className={s.subMenu}>
                            <div>
                                ...
                                <Link to={"/siteadmin/listsettings/14"}>
                                    <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                    <span>House Rules {/* Place Rules */}</span>
                                </Link>
                                <Link to={"/siteadmin/listsettings/15"}>
                                    <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                    <span>Review How Guests Book {/* How much notice before guest arrival */}</span>
                                </Link>
                                <Link to={"/siteadmin/listsettings/16"}>
                                    <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                    <span>Booking Notice Time {/* Experience Hours */}</span>
                                </Link>
                                <Link to={"/siteadmin/listsettings/18"}>
                                    <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                    <span>Minimum Nights {/* Booking Window */}</span>
                                </Link>
                                <Link to={"/siteadmin/listsettings/19"}>
                                    <FontAwesome.FaCircleThin className={s.navigationIcon} />
                                    <span>Maximum Nights {/* Cancellation Policy */}</span>
                                </Link>
                                <Link to={"/siteadmin/listsettings/23"}>
                                    <FontAwesome.FaCircleThin className={s.navigationIcon} />
