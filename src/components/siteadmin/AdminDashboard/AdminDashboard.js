...
// New images
import AdminPanel1 from './adminpanel1.jpg';
import AdminPanel2 from './adminpanel2.jpg';
import AdminPanel3 from './adminpanel3.jpg';
import AdminPanel4 from './adminpanel4.jpg';
import AdminPanel5 from './adminpanel5.jpg';
import AdminPanel6 from './adminpanel6.jpg';
import AdminPanel7 from './adminpanel7.jpg';
import AdminPanel8 from './adminpanel8.jpg';
import AdminPanel9 from './adminpanel9.jpg';
                        ...
                        <Row>
                            <Col xs={12} md={12} sm={12} lg={12}>
                                <div className={s.wrapper}>
                                        ...
                                        <Col sm={12} md={12} lg={12} className={s.nopad}>
                                            <Col sm={8} md={8} lg={8} className={s.nopad}>
                                                <Col sm={12} md={12} lg={12}>
                                                    <div className={cx(s.box, s.user)} style={{ backgroundImage: `url(${/*UserImage*/AdminPanel1})` }} >
                                                ...
                                                <Col sm={6} md={6} lg={6} className={s.paadR7}>
                                                    <div className={cx(s.box, s.todayuser)} style={{ backgroundImage: `url(${/*TodayUser*/AdminPanel2})` }} >
                                                        <div className={s.gridvalue}>
                                                ...
                                                <Col sm={6} md={6} lg={6} className={s.paadL8}>
                                                    <div className={cx(s.box, s.monthuser)} style={{ backgroundImage: `url(${/*Monthuser*/ AdminPanel3})` }} >
                                                        <div className={s.gridvalue}>
                                            ...
                                            <Col sm={4} md={4} lg={4} className={s.paadL0}>
                                                <div className={cx(s.box, s.listing)} style={{ backgroundImage: `url(${/*Listing*/AdminPanel4})` }} >
                                                    <div className={s.gridvalue}>
                                    ...
                                    <Row>
                                        <Col sm={6} md={6} lg={6} className={s.paadR7}>
                                            <div className={cx(s.box, s.todaylist)} style={{ backgroundImage: `url(${/*TodayList*/AdminPanel5})` }} >
                                                <div className={s.gridvalue}>
                                        ...
                                        <Col sm={6} md={6} lg={6} className={s.paadL8}>
                                            <div className={cx(s.box, s.monthlist)} style={{ backgroundImage: `url(${/*Listing*/AdminPanel6})` }} >
                                                <div className={s.gridvalue}>
                                    ...
                                    <Row>
                                        <Col sm={4} md={4} lg={4} className={s.paadR7}>
                                            <div className={cx(s.box, s.todaylist)} style={{ backgroundImage: `url(${/*Reserve*/AdminPanel7})` }} >
                                                <div className={s.gridvalue}>
                                        ...
                                        <Col sm={4} md={4} lg={4} className={cx(s.paadL8, s.paadR7)}>
                                            <div className={cx(s.box, s.daylist)} style={{ backgroundImage: `url(${/*Clock*/AdminPanel8})` }} >
                                                <div className={s.gridvalue}>
                                        ...
                                        <Col sm={4} md={4} lg={4} className={s.paadL8}>
                                            <div className={cx(s.box, s.resermoth)} style={{ backgroundImage: `url(${/*Listing*/AdminPanel9})` }} >
                                                <div className={s.gridvalue}>
