                  ...
                  >
                    <div className={cx(s.customMarkerContainer, { [s.hoveredMarker]: marker.hovered == true })}>
                      ...
                      <div className={s.customMarkerContent}>
                        ...
                        /> */}
                        <div className={s.customMarkerInnerContent}></div>
                      </div>
                  ...
                  >
                    <div>
                      <MapListingItem
                        ...
                        experienceTypes={marker.experienceTypes}
...
class MapResults extends React.Component {
  ...
  componentDidMount() {
    ...
    if (results && results.length > 0) {
      ...
      results.map((item) => {
        ...
        data.beds = item.beds;
        data.experienceTypes = item.experienceTypes;
        data.duration = item.listingData.duration;
        data.personCapacity = item.personCapacity;
        data.roomType = item.settingsData[0] && item.settingsData[0].listsettings && item.settingsData[0].listsettings.itemName;
  ...
  handleFitBounds(map) {
    ...
    console.log('Fit bounds: ', bounds, initialLoad);
...
const mapState = state => ({
  ...
  initialLoad: (selector(state, 'initialLoad') === true || selector(state, 'initialLoad') === false) ? selector(state, 'initialLoad') : true,
