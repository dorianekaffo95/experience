                    ...
                    return (
                      <div className={cx(s.listItem, s.displayInlineBlock)} key={item.id}>
                        <ListingItem
                          ...
                          roomType={item.settingsData[0] && item.settingsData[0].listsettings && item.settingsData[0].listsettings.itemName}
                          ...
                          duration={item.listingData.duration}
                        />
                      </div>
                    )
                  })
...
export default injectIntl(withStyles(s)(connect(mapState, mapDispatch)(SearchResults)));
