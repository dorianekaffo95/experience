...
class Booking extends Component {
  ...
  render() {
    ...
    const {
      bookDetails: { guests, selectedHour, adults, teens, childrenOrYounger, startDate, endDate },
    } = this.props;
      ...
      <div>
        ...
        {page === "payment" && (
          <Payment
            ...
            listType={bookingData.settingsData[0] && bookingData.settingsData[0].listsettings && bookingData.settingsData[0].listsettings.itemName}
            ...
            checkIn={startDate}
            checkOut={endDate}
            allowedPersonCapacity={selectedHour.availablePlaces /*bookingData.personCapacity*/}
            guests={guests}
            ...
            policyName={
              bookingData.listingData.cancellation &&
              bookingData.listingData.cancellation.policyName
            }
            ...
            adultPrice={bookingData.listingData.adultPrice}
            teenPrice={bookingData.listingData.teenPrice}
            childOrYoungerPrice={bookingData.listingData.childOrYoungerPrice}
            adultCapacity={bookingData.adultCapacity}
            teenCapacity={bookingData.teenCapacity}
            childOrYoungerCapacity={bookingData.childOrYoungerCapacity}
            spokenLanguages={bookingData.spokenLanguages}
            duration={bookingData.listingData.duration}
          />
        )}
      </div>
    );
