                    ...
                    <div className={cx(s.positionRelative)}>
                      <div className={cx(s.displayTableCell, s.vtrTop, s.contentWidth, s.paddingBottom, s.paddingLeft, s.mainSection)}>
                        <div className={s.contentSection}>
                          ...
                          {
                            step1 == "completed" && <a href="javascript:void(0);" className={s.modalCaptionLink} onClick={() => nextPage('index')}>
              ...
              <div>
                <div className={cx(s.displayTable, s.positionRelative)}>
                  <div className={s.displayTableRow}>
                    ...
                    <div className={cx(s.positionRelative)}>
                      <div className={cx(s.displayTableCell, s.vtrTop, s.contentWidth, { [s.paddingBottom]: storeCreation }, s.paddingLeft, s.mainSection)}>
                        <div className={s.contentSection}>
                  ...
                  <div className={s.displayTableRow}>
                    ...
                    <div className={cx(s.positionRelative)}>
                      <div className={cx(s.displayTableCell, s.vtrTop, s.contentWidth, s.paddingLeft, s.mainSection)}>
                        <div className={s.contentSection}>
                          <strong className={s.step}><span><FormattedMessage {...messages.step4Heading} /></span></strong>
                          <h3 className={s.landingContentTitle}><FormattedMessage {...messages.step4SubHeading} /></h3>
                          <p className={cx(s.landingTitleStep)}><span><FormattedMessage {...messages.step4HeadingContent} /></span></p>
                          {
                            step4 == "completed" && <a href="https://licence.visitmycellarstore.com/services" className={s.modalCaptionLink}>
