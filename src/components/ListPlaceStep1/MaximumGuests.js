...
class MaximumGuests extends Component {
  static propTypes = {
  ...
  async handleClick(e) {
    ...
    let updatedBedTypesArray =
      bedTypesValue && bedTypesValue.length > 0 ? bedTypesValue.slice(0) : [];
  ...
  belowMaximum = value => value <= this.props.personCapacity ? 'Cannot be more than maximum guest(s)' : undefined
  ...
  render() {
    ...
    const { personCapacity: maxGuests} = this.props;
            ...
            <div>
              ...
              <form onSubmit={handleSubmit}>
                <div className={s.landingMainContent}>
                  ...
                  <FormGroup className={s.formGroup}>
                    <ControlLabel className={s.landingLabel}>
                      <FormattedMessage {...messages.maximumGuests} />
                    </ControlLabel>
                    <Field
                      name="personCapacity"
                      type="text"
                      component={this.renderIncrementButton}
                      labelSingluar={formatMessage(messages.guest)}
                      labelPlural={formatMessage(messages.guests)}
                      minValue={1}
                      maxValue={50}
                      incrementBy={1}
                    />
                  ...
                  <FormGroup className={s.formGroup}>
                    <ControlLabel className={s.landingLabel}>
                      <FormattedMessage {...messages.maximumAdults} />
                    </ControlLabel>
                    <Field
                      name="adultCapacity"
                      type="text"
                      component={this.renderIncrementButton}
                      labelSingluar={formatMessage(messages.adult)}
                      labelPlural={formatMessage(messages.adults)}
                      minValue={1}
                      maxValue={!isNaN(maxGuests) ? maxGuests : 1}
                      incrementBy={1}
                    />
                  </FormGroup>
                  ...
                  <FormGroup className={s.formGroup}>
                    <ControlLabel className={s.landingLabel}>
                      <FormattedMessage {...messages.maximumTeens} />
                    </ControlLabel>
                    <Field
                      name="teenCapacity"
                      type="text"
                      component={this.renderIncrementButton}
                      labelSingluar={formatMessage(messages.teen)}
                      labelPlural={formatMessage(messages.teens)}
                      minValue={1}
                      maxValue={!isNaN(maxGuests) ? maxGuests : 1}
                      incrementBy={1}
                    />
                  ...
                  <FormGroup className={s.formGroup}>
                    <ControlLabel className={s.landingLabel}>
                      <FormattedMessage {...messages.maximumChildren} />
                    </ControlLabel>
                    <Field
                      name="childOrYoungerCapacity"
                      type="text"
                      component={this.renderIncrementButton}
                      labelSingluar={formatMessage(messages.child)}
                      labelPlural={formatMessage(messages.children)}
                      minValue={1}
                      maxValue={!isNaN(maxGuests) ? maxGuests : 1}
                      incrementBy={1}
                    />
                    ...
                    <FormGroup className={s.formGroup}>
                      ...
                      >
                        <Button
                          ...
                          onClick={() => previousPage("pluses-included")}
                        >
...
const mapState = (state) => ({
  ...
  personCapacity: selector(state, "personCapacity"),
...
export default injectIntl(
  withStyles(s)(connect(mapState, mapDispatch)(MaximumGuests))
);
