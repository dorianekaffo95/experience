...
class Payment extends React.Component {
  ...
  render() {
    ...
    const { data: { listData: { adultPrice, teenPrice, childOrYoungerPrice, adults, teens, childrenOrYounger } } } = this.props;
    const { data: { adultCapacity, teenCapacity, childOrYoungerCapacity } } = this.props;
