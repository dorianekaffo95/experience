...
export const payment = {
  ...
  stripe: {
    secretKey: process.env.STRIPE_SECRET || 'sk_test_9nlfPrFYVxpg0K2DdRwahqun', /* From ENV */
    publishableKey: process.env.STRIPE_PUBLISHABLE || 'pk_test_3DbjLdpBqXOfOAjjf0nQq9av'
  }
