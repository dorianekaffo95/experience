...
ENV DATABASE_URL=mysql://my_cellar:my_cellar@db_mysql/visit_my_cellar
ENV DATABASE_USER=mycellar
ENV DATABASE_PASSWORD=mycellar
ENV DATABASE_NAME=visit_my_cellar
ENV DATABASE_HOST=db_mysql
...
ENV SMTP_LOGIN_PASSWORD=KvjFGbX8m15aD0nw
ENV SMTP_PORT=587
ENV SMTP_LOGIN_EMAIL=dorianekaffo1@gmail.com
...
# Twilio
ENV TWILIO_ACCOUNTSID=AC0ade1ac82a02154f8c8ce02e220ea52f
ENV TWILIO_AUTHTOKEN=564555083e33f376cef442160a9dba59
ENV TWILIO_PHONENUMBER=+14422673651
